 ...
 */
public class CarDetailActivity extends EditableActivity {
    ...
    public void onResume() {
        super.onResume();
        try {
            ((EconomyLayout)findViewById(R.id.car_detail_layout_economy)).applyPreferences();
            ((MeasurementsLayout)findViewById(R.id.car_detail_layout_measurements)).applyPreferences();
        } catch (Exception e) { Log.e("Exception while resuming: ", e.getMessage()); }
    }
